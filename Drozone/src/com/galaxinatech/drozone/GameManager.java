package com.galaxinatech.drozone;
...
import com.galaxinatech.drozone.graphics.Sprite;
import com.galaxinatech.drozone.input.GameAction;
import com.galaxinatech.drozone.input.InputManager;
import com.galaxinatech.drozone.sound.EchoFilter;
import com.galaxinatech.drozone.sound.MidiPlayer;
import com.galaxinatech.drozone.sound.Sound;
import com.galaxinatech.drozone.sound.SoundManager;
import com.galaxinatech.drozone.sprites.Creature;
import com.galaxinatech.drozone.sprites.Player;
import com.galaxinatech.drozone.sprites.PowerUp;
import com.galaxinatech.drozone.state.StateManager;
...
public class GameManager extends GameCore {
	...
	public void checkState() {
		if (stateManager.getCurrentState() == StateManager.STATE_MENU) {
			// Render menu
			screen.getGraphics().dispose();
		} else if (stateManager.getCurrentState() == StateManager.STATE_GAME) {
			// Render game
			screen.getGraphics().dispose();
			gameLoop();
		}
	...
	private void initInput() {
		...
		play = new GameAction("play", GameAction.DETECT_INITAL_PRESS_ONLY);
		...
		inputManager.mapToKey(play, KeyEvent.VK_ENTER);
	}
	...
	private void checkInput(long elapsedTime) {
		...
		if(play.isPressed() && stateManager.getCurrentState() == StateManager.STATE_MENU) {
			stateManager.setCurrentState(StateManager.STATE_GAME);
			checkState();
		}
